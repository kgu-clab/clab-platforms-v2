...
export const modalHeaderTopVariant = cva('flex items-center justify-between w-full', {
  variants: {},
  defaultVariants: {},
});

export const modalTitleVariant = cva('text-[14px] font-medium leading-[1.5] text-gray-4', {
  variants: {},
  defaultVariants: {},
});

export const modalSubtitleVariant = cva('text-[18px] font-semibold leading-[1.4] text-black', {
  variants: {},
  defaultVariants: {},
});

export const modalDescriptionVariant = cva('text-[18px] font-medium leading-[1.4] text-black', {
  variants: {},
  defaultVariants: {},
});
